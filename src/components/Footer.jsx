        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              </a>              <a href="https://github.com/trailblazer-analytics" aria-label="GitHub" className="hover:text-brandGold transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/@trailblazeranalytics" aria-label="YouTube" className="hover:text-brandGold transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
